...
## 6.5 免费 / 付费的切分（2026-09 调整）

调研结论：合盘 + 详细星盘占付费内容消费的 **40–55%**，而 Co-Star 刚把好友合盘
锁进付费墙——那是它当年出圈的功能，现在是差评榜第一。

所以这里做了一个反向决定：**合盘评分永久免费、不限次数**。

| 免费 | 付费 |
|---|---|
| 合盘分数、东西方分列得分、绿旗/红旗 | 长文关系解读 |
| **六项因子的完整推导过程** | 双方行运重叠的月份时机 |
| 分享卡（IG Story 竖版） | |

第二行是关键：**一个主打"摊开算法"的产品，不能收费才给看算法**。
卖的是叙述和时机，不是计算。计算永远免费且透明。
